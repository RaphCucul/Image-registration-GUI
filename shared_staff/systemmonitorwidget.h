 ...
 * @brief The SystemMonitorWidget class is the parent class for CPU and RAM memory usage widgets. Because both widgets are
 * using QtCharts, virtual functions can be declared. Earlier, there was also HDDWidget class, but now it is depricated and
 * it is replaced by HDDUsagePlot class.
